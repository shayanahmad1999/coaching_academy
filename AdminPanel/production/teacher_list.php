<?php 
  ...
  if (isset($_GET['id']) && $_GET['id'] != "") {
   ...
   if ($status == 0) {
       ...
       $query = "update teachers set techerStatus = 1 where Teacher_ID = '$id'";
       $go=mysqli_query($connect,$query);
       
     }
     else{
     
      $query = "update teachers set techerStatus = 0 where Teacher_ID = '$id'";
      $go=mysqli_query($connect,$query);
  ...
  inner join academy on teachers.Academies_ID = academy.Academies_ID
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Teacher <small>List</small></h3>
              </div>

              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                     <span class="input-group-btn"> <a href="Teacher/teacher_deleteall.php" onclick="return confirm('are you sure want to Delete All record from your list?')" >
            ...
            <div class="row">
                  ...
                  <div class="x_title">
                    <?php 
                                   ...
                                   elseif (isset($_GET['msgs']) && $_GET['msgs'] == 'error') {
                                    ...
                                    // echo " <h2>Teacher List<small>sub title</small></h2>
              ...
              <div class="row">
                ...
                <div class="col-md-2"></div>
                <div class="col-md-2">
                    <a href="teacher_form.php"><button class="btn btn-primary">Add</button></a>
                </div>
              </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered " style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo  $list['Teacher_Email']; ?></td>
                          <td><?php echo  $list['Teacher_Confirm_Email']; ?></td>
                          <td><?php echo  $list['Teacher_Phone']; ?></td>
                          <td><?php echo  $list['Teacher_Password']; ?></td>
                          <td><?php echo  $list['Teacher_Repeat_Password']; ?></td>
                          <td><?php echo  $list['Teacher_Telephone']; ?></td>
                          <td><?php echo  $list['Teacher_Gender']; ?></td>
                          <td><img src="uploads/<?php echo $list['Teacher_Photo'];?>"class="rounded-circle" weight = "50px" height = "50px" alt=""></td>
                          <td><?php echo  $list['Teacher_Address']; ?></td>
                          <td><?php echo  $list['Academy_Name']; ?></td>
                          <td><?php echo  $list['Course_Name']; ?></td>
                          <td>
                            <?php  
                              if ($list['techerStatus'] == 0) { ?>
                            <a href="teacher_list.php?id=<?php echo $list['Teacher_ID'];?>
                            &&status=<?php echo $list['techerStatus']; ?>">
                            <button class="btn btn-danger"><i class="fa fa-times"></i></button></a>
                            <?php } else { ?>
                              <a href="teacher_list.php?id=<?php echo $list['Teacher_ID'];?>&&status=<?php echo $list['techerStatus']; ?>"><button class="btn btn-success"><i class="fa fa-check"></i></button></a>

                              <a href="teacher_edit.php?id=<?php echo $list['Teacher_ID']; ?>" onclick="return confirm('are you sure want to edit this record from your list?')" ><button class="btn btn-info"><i class="fa fa-edit"></i></button></a>

                               <a href="Teacher/teacher_delete.php?id=<?php echo $list['Teacher_ID']; ?>" onclick="return confirm('are you sure want to delete this record from your list?')" ><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
<!-- 
