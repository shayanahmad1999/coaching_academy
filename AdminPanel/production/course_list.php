<?php 
  ...
  if (isset($_GET['id']) && $_GET['id'] != "") {
   ...
   if ($status == 0) {
       $query = "update courses set courseStatus = 1 where Course_ID = '$id'";
       $go=mysqli_query($connect,$query);
     }
     else{
      $query = "update courses set courseStatus = 0 where Course_ID = '$id'";
      $go=mysqli_query($connect,$query);
     }
    }

  $query = "select * from courses
  inner join academy on courses.Academies_ID = academy.Academies_ID";
          ...
          <div class="">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <span class="input-group-btn">
                        <a href="Course/course_deleteall.php" onclick="return confirm('are you sure want to Delete All record from your list?')" >
            ...
            <div class="row">
                  ...
                  <div class="x_title">
                    <?php 
                                   ...
                                   elseif (isset($_GET['msgs']) && $_GET['msgs'] == 'error') {
                                    ...
                                    // echo " <h2>Course List<small>sub title</small></h2>
             ...
             <div class="row">
                ...
                <div class="col-md-2"></div>
                <div class="col-md-2">
                    <a href="course_form.php"><button class="btn btn-primary">Add</button></a>
                </div>
              </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo  $list['Credit_Hours']; ?></td>
                          <td><img src="uploads/<?php echo $list['Course_photo'];?>"class="rounded-circle" weight = "50px" height = "50px" alt=""></td>
                          <td><?php echo  $list['Course_Fee']; ?></td>
                          <td><?php echo  $list['Academy_Name']; ?></td>
                
                          <td>
                            <?php if ($list['courseStatus'] == 0) { ?>
                            <a href="course_list.php?id=<?php echo $list['Course_ID'];?>&&status=<?php echo $list['courseStatus']; ?>"><button class="btn btn-danger"><i class="fa fa-times"></i></button></a>
                            <?php } else { ?>
                              <a href="course_list.php?id=<?php echo $list['Course_ID'];?>&&status=<?php echo $list['courseStatus']; ?>"><button class="btn btn-success"><i class="fa fa-check"></i></button></a>

                              <a href="course_edit.php?id=<?php echo $list['Course_ID']; ?>" onclick="return confirm('are you sure want to edit this record from your list?')" ><button class="btn btn-info"><i class="fa fa-edit"></i></button></a>

                               <a href="Course/course_delete.php?id=<?php echo $list['Course_ID']; ?>" onclick="return confirm('are you sure want to delete this record from your list?')" ><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                       <?php $a++; } }  ?>
                      </tbody>
