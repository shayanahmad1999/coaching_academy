                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" action="Academy/Academy_Insertion.php" method="post" novalidate enctype="multipart/form-data">
                                        
                                        <span class="section">Academy Info</span>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Name<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="ex. Academy Name" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <input type="hidden" name="academy" value="submit">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
