                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" action="Course/Course_update.php" method="post" novalidate enctype="multipart/form-data">
                                        
                                        <span class="section">Course Info</span>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Name<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="coursename" value="<?php echo $edit['Course_Name']; ?>" placeholder="ex. Course Name" required="required" />
                                            </div>
                                        </div>
                                       <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Credit Hours<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="crdhour" value="<?php echo $edit['Credit_Hours']; ?>" placeholder="ex. Credit Hours" required="required" />
                                            </div>
                                        </div>
                                         ...
                                         <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <img src="uploads/<?php echo $edit['Course_photo']; ?>" class="rounded-circle" weight="50px" height="50px">
                                                <input type="file" class="form-control" name="photo">

                                                <input type="hidden" name="oldphoto" value="<?php echo $edit['Course_photo']; ?>">
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">FEE<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="course_fee" required="required" / value="<?php echo $edit['Course_Fee']; ?>">
                                            </div>
                                        </div>
                                            <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <input type="hidden" name="update" value="<?php echo $edit['Course_ID']; ?>">
